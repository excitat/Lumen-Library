...
<!--________________________Timer________________________________-->
							...
							<ul style="margin-top: -10px;" class="nav navbar-nav navbar-right">
								...
								<li><a href="message.php" style="margin-top: 5px;"><span class="glyphicon glyphicon-envelope"></span><span class="badge">0</span> </li>
	...
	<?php
		if(isset($_SESSION['login_user']))
		{
			...
			$x=mysqli_query($db,"SELECT return_date from issue_book where username ='$_SESSION[login_user]' and approve = '$expire' ;");
